...
# k=[a[i:i+7] for i in range(0,len(a),7) ];
# temp=k[:-1]
# l=[]
...
# 	if(a[i:i+3].isupper()==True and a[i+3].islower()==True and a[i+4:i+7].isupper()==True):
# 	  print(a[i:i+3]+ a[i+3]+ a[i+4:i+7])

print(re.findall('[a-z][A-Z][A-Z][A-Z][a-z][A-Z][A-Z][A-Z][a-z]',a))
